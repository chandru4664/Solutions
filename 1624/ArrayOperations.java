...
public class ArrayOperations {
	public static void main(String[] args) {
		...
		System.out.println("The number of odd numbers divisible by 3 in even positions = " + ArrayOperations.oddNumberCounter(arr));
		
		//Search for a key value in array and print it is available in the array or not.
		searchKey=81;
		if(ArrayOperations.searchKeyInArray(arr,searchKey) == false) {
		...
		ArrayOperations.countPrimeNumber(arr);
	}
