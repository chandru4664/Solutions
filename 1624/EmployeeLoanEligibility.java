...
public class EmployeeLoanEligibility {
	public static void main(String[] args) {
		...
		EmployeeLoanEligibility EmployeeLoanEligibility = new EmployeeLoanEligibility();

		//a married temporary job holder
		System.out.println("Condition: a married temporary job holder");
		System.out.println("Loan Amount: " + EmployeeLoanEligibility.calculateLoanAmount(married, jobType, numberOfYearsOfService));
		System.out.println();
